...
const S := {
	...
	"menu.conquest.sub": ["Doğru cevapla sahneyi boya, alanı ele geçir.", "Answer right, paint the stage, hold the ground."],
	...
	"howto.c1": ["Sahne karolara bölünür, her soru bir karo.", "The stage is split into tiles, one per question."],
	"howto.c2": ["En hızlı doğru cevap karoyu kendi rengine boyar.", "The fastest correct answer paints the tile."],
